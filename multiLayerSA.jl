...
# Making these vary high makes the layout prefer switching hands/fingers
# Low makes them prefer using the same hand/finger twice
const doubleFingerEffort = 1.5
const doubleHandEffort = -1

const fingerCPM = [280, 340, 430, 450, 44, 44, 27, 28] # how many clicks can you do in a minute
...
const rowCPM = [140, 150, 180, 130, 100]
meanCPM = mean(rowCPM)
stdCPM = std(rowCPM)
...
# based on linear (x, y, row, finger)
# numbered by strength
moonlanderLayoutMap1 = Dict{Int, Tuple{Float64, Float64, Int, Int, Int}}(
    23 =>  (0.5, 4.5, 1, 1, 0),
    16 =>  (1.5, 4.5, 1, 2, 0),
    10 =>  (2.5, 4.5, 1, 3, 0),
    4  =>  (3.5, 4.5, 1, 4, 0),
...
# based on linear (x, y, row, finger)
# numbered by strength
moonlanderLayoutMap2 = Dict{Int, Tuple{Float64, Float64, Int, Int, Int}}(
    22 =>  (0.5, 4.5, 1, 1, 0),
    15 =>  (1.5, 4.5, 1, 2, 0),
    10 =>  (2.5, 4.5, 1, 3, 0),
    4  =>  (3.5, 4.5, 1, 4, 0),
    ...
    23 =>  (0.5, 0.5, 5, 1, 0),
    17 =>  (1.5, 0.5, 5, 2, 0),
    18 =>  (2.5, 0.5, 5, 4, 0), # note the finger weirdness
    11 =>  (3.5, 0.5, 5, 4, 0),
    34 =>  (7.5, 0.5, 5, 5, 0),
    41 =>  (8.5, 0.5, 5, 5, 0), # note the finger weirdness
    40 =>  (9.5, 0.5, 5, 7, 0),
    46 =>  (10.5, 0.5, 5, 8, 0),
)
